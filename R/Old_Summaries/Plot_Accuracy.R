...
Sigma_Data = Data %>% filter(Solution_Type != "Ideal", Solution_Type!="MIO_3T_sec", N == "1000") %>% group_by(P,T,Sigma,Solution_Type) %>% summarize(mean.value=mean(Accuracy),max.value=max(Accuracy),min.value=min(Accuracy))
...
Save_str = paste("Plots/Accuracy/vs_Sigma/MIO_by_N.png", sep="")
png(file=Save_str,width=1000, height=700)
print(plot_4)
dev.off()
...
#                 alpha=.1) +
    facet_grid(P~T, labeller=label_both) +
    ggtitle(paste("Mean Accuracy vs", type, "Rho by Solution Type")) +
    theme(axis.text=element_text(size=16),
          axis.title=element_text(size=18,face="bold"),
          plot.title=element_text(size = rel(2)),
          legend.text=element_text(size=14),
  ...
  plot_2 = ggplot(data = Heuristic_Data,
    ...
    geom_ribbon(data=Heuristic_Data,
                ...
                alpha=.1) +
    facet_grid(P~T, labeller=label_both) +
    ggtitle(paste("Mean Heuristic Accuracy vs", type, "Rho by Number of Starting Points (N)")) +
    theme(axis.text=element_text(size=16),
          axis.title=element_text(size=18,face="bold"),
          plot.title=element_text(size = rel(2)),
          legend.text=element_text(size=14),
  ...
  plot_3 = ggplot(data = MIO_Data,
    ...
    geom_ribbon(data=MIO_Data,
                ...
                alpha=.1) +
    facet_grid(P~T, labeller=label_both) +
    ggtitle(paste("Mean MIO Accuracy vs", type, "Rho by Scenario Type")) +
    theme(axis.text=element_text(size=16),
          axis.title=element_text(size=18,face="bold"),
          plot.title=element_text(size = rel(2)),
          legend.text=element_text(size=14),
  ...
  plot_4 = ggplot(data = MIO_Data2,
    ...
    geom_ribbon(data=MIO_Data2,
                ...
                alpha=.1) +
    facet_grid(P~T, labeller=label_both) +
    ggtitle(paste("Mean MIO Accuracy vs", type, "Rho by Number of Heuristic Starting Points (N)")) +
    theme(axis.text=element_text(size=16),
          axis.title=element_text(size=18,face="bold"),
          plot.title=element_text(size = rel(2)),
          legend.text=element_text(size=14),
