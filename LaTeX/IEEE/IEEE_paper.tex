...
\section{Detection Ambiguity Penalty Values}\label{sec:Penalty_Appendix}
\input{../Content/appa}

\section{Robust MIO With Number of Targets as a Decision Variable}\label{sec:Robust_Appendix}
\input{../Content/appb}

\section{Trajectory Assignment Pairing}\label{sec:Assignment_Appendix}
\input{../Content/appc}
